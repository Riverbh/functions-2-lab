...
const myChoice = (num1, num2) => console.log(`The first parameter is ${num1}. The second parameter is ${num2}`)
...
const greetin = (firstName, lastName, callback) => {
    return callback(firstName, lastName)
}

// INVOKE 'GREETING FUNCTION' HERE

greetin("River", "Hansen", fullName)
...
pricesPlusTax(prices, (totalCost) => console.log(totalCost))
